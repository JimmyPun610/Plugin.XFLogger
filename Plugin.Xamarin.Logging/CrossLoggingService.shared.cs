...
namespace Plugin.Xamarin.Logging
{
    ...
    {
        static Lazy<ILoggingService> implementation = new Lazy<ILoggingService>(() => CreateLogging(), System.Threading.LazyThreadSafetyMode.PublicationOnly);
    ...
    static ILoggingService CreateLogging()
    {
#if NETSTANDARD2_0
            return null;
#else
